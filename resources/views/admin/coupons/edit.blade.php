            ...
            <form action="{{route('coupons.update', $coupon->id)}}" class="parsley-examples" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-3">
                        ...
                        <select name="company" class="form-control">
                            <option value="all" {{$coupon->company_id == ''?'selected':''}}>{{translate('All company')}}</option>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-3" id="coupon_order_type">
                        ...
                        <input type="number" name="order_count" class="form-control" value="{{$coupon->order_count}}" id="order_count" required/>
                    </div>
                    <div class="mb-3 col-2">

                                ...
                                <table id="datatable" class="table table-striped table-bordered dt-responsive">
                                    ...
                                    <tr>
                                        <th>
                                            ...
                                            {{--                                            <div class="row">--}}
                                            {{--                                                <div class="col-3">--}}
                                            {{--                                                    <h4 class="mt-0 header-title">{{translate('Order number 11223344')}}</h4>--}}
                                            {{--                                                </div>--}}
                                            {{--                                                <div class="col-3">--}}
                                            {{--                                                    <h5 class="header-title">{{translate('The order was created in: ')}} {{translate('November 25, 2023 at 1:30 p.m.')}}</h5>--}}
                                            {{--                                                </div>--}}
                                            {{--                                                <div class="col-3">--}}
                                            {{--                                                    <button>{{translate('Payment upon receipt')}}</button>--}}
                                            {{--                                                </div>--}}
                                            {{--                                                <div class="col-3">--}}
                                            {{--                                                    {{translate('Status')}} <span class="badge badge-outline-light">{{translate('New order')}}</span>--}}
                                            {{--                                                </div>--}}
                                            {{--                                            </div>--}}
                                        </th>
                                    </tr>

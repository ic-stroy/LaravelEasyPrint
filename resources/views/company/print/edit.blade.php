    ...
    <div class="card">
        <div class="card-body">
            ...
            <p class="text-muted font-14">
                {{translate('Warehouse print products list edit')}}
            </p>
            <form action="{{route('print.update', $warehouse->id)}}" class="parsley-examples" method="POST" enctype="multipart/form-data">
                @csrf
                @method("PUT")

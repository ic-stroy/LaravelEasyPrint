                    ...
                    <tr>
                        ...
                        <td>
                            <a class="show_page" href="{{ route('company_user.show', $user->id) }}">
                                @if(isset($user->role_id))
                                    @if($user->role_id == 0){{ __('Stuff') }}@elseif($user->role_id == 1)  {{ __('Seller') }} @elseif($user->role_id == 2) {{ __('User') }} @else <div class="no_text"></div> @endif
                                @endif
                            </a>
                        </td>
                        <td>
                        ...
                        <td class="function_column">
                            <div class="d-flex justify-content-center">
                                <a class="form_functions btn btn-info" href="{{route('company_user.edit', $user->id)}}"><i class="fe-edit-2"></i></a>
